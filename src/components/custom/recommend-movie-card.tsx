...
import { Movie, RecommendMovie } from "@/app/api/types/movie.type";
...
export type RecommandMovieCardProps = {
    movie: RecommendMovie;
    onClick?: () => void;
}

export const RecommendMovieCard = (props: RecommandMovieCardProps) => {
    ...
    return (
      ...
      >
        <div className="w-40 relative h-[15rem] group">
          ...
          <MovieActionPopover movieId={movie.tmdb_id}>
            <Button
              variant="ghost"
              size="icon"
